    ...
    mw.hook("wikipage.content").add(
        ...
        ($content) =>
            (async () => {
                ...
                const pluginsSet = new Set(["match-braces"]);
                ...
                await mw.loader.using([...[...langSet].map((lang) => `ext.gadget.prism-language-${lang}`), ...[...pluginsSet].map((plugin) => `ext.gadget.prism-plugin-${plugin}`)]);
