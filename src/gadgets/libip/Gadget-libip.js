...
!(function () {
            ...
            !function () {
                ...
                function from(value, encodingOrOffset, length) {
                    if ("string" == typeof value)
                        return ((string, encoding) => {
                            var length, buf;
                            if (Buffer.isEncoding((encoding = "string" == typeof encoding && "" !== encoding ? encoding : "utf8")))
                                return (
                                    (length = 0 | byteLength(string, encoding)),
                                    (buf = createBuffer(length)),
                                    (buf = (string = buf.write(string, encoding)) !== length ? buf.slice(0, string) : buf)
                                );
                    ...
                    if (isInstance(value, ArrayBuffer) || (value && isInstance(value.buffer, ArrayBuffer)))
                        return ((array, byteOffset, length) => {
                                ...
                                ((array =
                                    void 0 === byteOffset && void 0 === length
                                        ...
                                        : void 0 === length
                                          ...
                                          : new Uint8Array(array, byteOffset, length)).__proto__ = Buffer.prototype),
                                array
                            );
                    ...
                    valueOf = ((obj) => {
                        ...
                        return Buffer.isBuffer(obj)
                            ? ((len = 0 | checked(obj.length)), 0 !== (buf = createBuffer(len)).length && obj.copy(buf, 0, 0, len), buf)
                            : void 0 !== obj.length
                              ? "number" != typeof obj.length || numberIsNaN(obj.length)
                                  ? createBuffer(0)
                                  : fromArrayLike(obj)
                              : "Buffer" === obj.type && Array.isArray(obj.data)
                ...
                function slowToString(encoding, start, end) {
                    ...
                    for (encoding = encoding || "utf8"; ; )
                        switch (encoding) {
                            ...
                            case "base64":
                                return ((buf, start, end) => (0 === start && end === buf.length ? _$base64Js_2.fromByteArray(buf) : _$base64Js_2.fromByteArray(buf.slice(start, end))))(
                                    this,
                                    start,
                                    end,
                                );
                    ...
                    if ("number" == typeof val)
                        return (
                            ...
                            "function" == typeof Uint8Array.prototype.indexOf
                                ? (dir ? Uint8Array.prototype.indexOf : Uint8Array.prototype.lastIndexOf).call(buffer, val, byteOffset)
                            ...
                            switch (bytesPerSequence) {
                                ...
                                case 3:
                                    ((secondByte = buf[i + 1]),
                                        ...
                                        128 == (192 & secondByte) &&
                                            128 == (192 & thirdByte) &&
                                            2047 < (tempCodePoint = ((15 & firstByte) << 12) | ((63 & secondByte) << 6) | (63 & thirdByte)) &&
                                ...
                                case 4:
                                    ((secondByte = buf[i + 1]),
                                        ...
                                        128 == (192 & secondByte) &&
                                            128 == (192 & thirdByte) &&
                                            128 == (192 & fourthByte) &&
                                            65535 < (tempCodePoint = ((15 & firstByte) << 18) | ((63 & secondByte) << 12) | ((63 & thirdByte) << 6) | (63 & fourthByte)) &&
                                            tempCodePoint < 1114112 &&
                                            (codePoint = tempCodePoint));
                            }
                        (null === codePoint
                            ? ((codePoint = 65533), (bytesPerSequence = 1))
                            : 65535 < codePoint && (res.push((((codePoint -= 65536) >>> 10) & 1023) | 55296), (codePoint = 56320 | (1023 & codePoint))),
                            res.push(codePoint),
                            (i += bytesPerSequence));
                    }
                    return ((codePoints) => {
                ...
                ((Buffer.TYPED_ARRAY_SUPPORT = (() => {
                    ...
                    (Buffer.alloc = function (size, fill, encoding) {
                        return ((size, fill, encoding) => (
                            assertSize(size),
                            !(size <= 0) && void 0 !== fill ? ("string" == typeof encoding ? createBuffer(size).fill(fill, encoding) : createBuffer(size).fill(fill)) : createBuffer(size)
                        ))(size, fill, encoding);
                    }),
                    ...
                    (Buffer.prototype.compare = function (target, start, end, thisStart, thisEnd) {
                        ...
                        if (
                            ...
                            (start = void 0 === start ? 0 : start) < 0 || end > target.length || thisStart < 0 || thisEnd > this.length)
                        )
                    ...
                    (Buffer.prototype.write = function (string, offset, length, encoding) {
                        ...
                        if (((void 0 === length || remaining < length) && (length = remaining), (0 < string.length && (length < 0 || offset < 0)) || offset > this.length))
                ...
                ((Buffer.prototype.slice = function (start, end) {
                    ...
                    (Buffer.prototype.copy = function (target, targetStart, start, end) {
                        ...
                        else if (this === target && start < targetStart && targetStart < end) for (var i = len - 1; 0 <= i; --i) target[i + targetStart] = this[i + start];
                    ...
                    (Buffer.prototype.fill = function (val, start, end, encoding) {
                        ...
                        var i;
                        if (!(end <= start))
                            if (((start >>>= 0), (end = void 0 === end ? this.length : end >>> 0), "number" == typeof (val = val || 0))) for (i = start; i < end; ++i) this[i] = val;
                            else {
                ...
                function base64ToBytes(str) {
                    return _$base64Js_2.toByteArray(
                        ((str) => {
        ...
        _$base64Js_2 = {
            toByteArray: function (b64) {
                var tmp,
                    ...
                    validLen = lens[0],
                    lens = lens[1],
                    arr = new Arr(((validLen, placeHoldersLen) => (3 * (validLen + placeHoldersLen)) / 4 - placeHoldersLen)(validLen, lens)),
                    curByte = 0,
                    ...
                    value = Math.abs(value),
                        isNaN(value) || value === 1 / 0
                            ...
                            : ((e = Math.floor(Math.log(value) / Math.LN2)),
                              ...
                              2 <= (value += 1 <= e + eBias ? rt / isLE : rt * Math.pow(2, 1 - eBias)) * isLE && (e++, (isLE /= 2)),
                              eMax <= e + eBias
                                  ? ((m = 0), (e = eMax))
                                  : 1 <= e + eBias
                                    ? ((m = (value * isLE - 1) * Math.pow(2, mLen)), (e += eBias))
        ...
        ipv4Regex =
            ((ip.toBuffer = function (ip, buff, offset) {
                ...
                if (this.isV4Format(ip))
                    ...
                    if ("" === sections[0]) for (; sections.length < 8; ) sections.unshift("0");
                    else if ("" === sections[sections.length - 1]) for (; sections.length < 8; ) sections.push("0");
    ...
    ((ip.isV4Format = function (ip) {
        ...
        (ip.mask = function (addr, mask) {
            ...
            else if (4 === mask.length) for (i = 0; i < mask.length; i++) result[i] = addr[addr.length - 4 + i] & mask[i];
            else {
        ...
        (ip.cidr = function (cidrString) {
            var cidrString = cidrString.split("/"),
                addr = cidrString[0];
        ...
        (ip.subnet = function (addr, mask) {
            ...
            for (let i = 0; i < maskBuffer.length; i++)
                if (255 === maskBuffer[i]) maskLength += 8;
                else {
        ...
        (ip.isLoopback = function (addr) {
            return (
                /\./.test(addr) || /:/.test(addr) || (addr = ip.fromLong(Number(addr))),
        ...
        (ip.address = function (name, family) {
            ...
            return (
                ...
                name && "private" !== name && "public" !== name
                    ? 0 === (res = interfaces[name].filter((details) => _normalizeFamily(details.family) === family)).length
                        ? void 0
                        : res[0].address
                    : (res = Object.keys(interfaces)
                            .map((nic) => {
                                nic = interfaces[nic].filter(
                                    (details) => (
            ...
            var parts = addr
                ...
                .map((part) =>
                    part.startsWith("0x") || part.startsWith("0X")
                        ? parseInt(part, 16)
                        : part.startsWith("0") && "0" !== part && /^[0-7]+$/.test(part)
                          ? parseInt(part, 8)
                          : /^[1-9]\d*$/.test(part) || "0" === part
                            ? parseInt(part, 10)
                            : NaN,
                );
